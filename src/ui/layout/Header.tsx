...
function Header(props: {
  ...
  return (
    <div className="z-10 sticky top-0 z-999 flex ml-0 rounded-lg mb-6 bg-white">
        <div className="flex flex-grow items-center justify-between px-6 py-3 shadow-2">
            ...
            <div className="">
                ...
                <Link className="block flex-shrink-0" to="/">
                    ...
                    <p className='text-[#313030] text-[24px] font-medium'>Welcome Admin </p>
                    <span className='text-sm text-[#686868]'>Stay Updated. Stay Ahead.</span>
                </Link>
            </div>
